<?php 
  ...
  class PDF extends FPDF
  {
    function Header(){
      ...
      $this->Cell(50,10,"PT Indomarco Adi Prima",0,1);
      $this->SetFont('Arial','',14);
      $this->Cell(50,7,"JL. Trunojoyo Mulyo Rejo, Karang Tengah ,",0,1);
      $this->Cell(50,7,"Rt.01 Rw.02 ,",0,1);
      $this->Cell(50,7,"Kabupaten Ngawi",0,1);
      $this->Cell(50,7,"Nomor Telpon : (+62 87883351335)",0,1);
    ...
    function body($info,$products_info){
      ...
      $this->Cell(50,10,"Receipt Invoice Untuk : ",0,1);
      ...
      $this->SetY(55);
      $this->SetX(-60);
      $this->Cell(50,7,"Nomor Invoice : ".rand());
      
      //Display Invoice date
      $this->SetY(63);
      $this->SetX(-60);
      $this->Cell(50,7,"Tanggal Invoice  : ".$info["invoice_date"]);
      
      //Display Table headings
      $this->SetY(95);
      $this->SetX(10);
      $this->SetFont('Arial','B',12);
      $this->Cell(80,9,"Nama Produk",1,0);
      $this->Cell(40,9,"Harga",1,0,"C");
      $this->Cell(30,9,"Jumlah",1,0,"C");
    ...
    function Footer(){
      ...
      $this->SetY(-50);
      $this->SetFont('Arial','B',12);
      $this->Cell(0,10,"PT INDOMARCO Adi Prima",0,1,"R");
      $this->Ln(15);
      $this->SetFont('Arial','',12);
      ...
      //Display Footer Text
      $this->Cell(0,10,"Ini Merupakan Invoice Otomatis",0,1,"C");
